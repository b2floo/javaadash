...
/**
 * This is an example of a simple TC2 game.
 * Players both have 2 characters and 4 cards in hand.
 * They choose their characters, then the action. 
 * Turn resolver is a mock one so no settings are modified at character level.
 * The game end when a player dont have enough cards to fill their hand (append at same time for both players
 * so game end up with a tie)
 * 
 * @author b2floo
 *
 */
public class VerySimpleTC2Game {
	...
	public static void main(String[] args) throws Exception {
		...
		gm.getStateResolver().setTurnResolver(new VerySimpleTC2Game().new MockTurnResolver());
		gm.startGame(p1, p2);
