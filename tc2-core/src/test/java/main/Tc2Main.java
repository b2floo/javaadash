...
public class Tc2Main 
{
	public static void main(String[] args) throws Exception
	{
		...
		deck1.addCard(new Card(-1,CardType.CHARACTER, "ABI", 
		...
		deck1.addCard(new Card(-1,CardType.CHARACTER,  "ABO", 
				effects, new ArrayList<Condition>(), Card.createSettings("ATT:4 - DEF:3 - LIFE: 6 - CLASS: WIZARD - GUILD: ZIL")));
		effects = generator.getEffets(1);
		deck1.addCard(new Card(-1,CardType.CHARACTER, "ABU", 
		...
		for(int i=0; i<nbActions; i++)
		{
			...
			deck1.addCard(new Card(-1, CardType.ACTION, "ACTION"+i, effects, conditions, new HashMap<String, String>()));
		}
		...
		effects = generator.getEffets(1);
		deck2.addCard(new Card(-1,CardType.CHARACTER, "YLI", 
				effects , new ArrayList<Condition>(), Card.createSettings("ATT:4 - DEF:1 - LIFE: 9 - CLASS:WARRIOR - GUILD: NOZ"))); 
		effects = generator.getEffets(1);
		deck2.addCard(new Card(-1,CardType.CHARACTER, "YLO", 
				effects , new ArrayList<Condition>(), Card.createSettings("ATT:4 - DEF:3 - LIFE: 5 - CLASS:PRIEST - GUILD:NOZ")));
		effects = generator.getEffets(1);
		deck2.addCard(new Card(-1,CardType.CHARACTER, "YLU", 
				effects , new ArrayList<Condition>(), Card.createSettings("ATT:5 - DEF:2 - LIFE: 5 - CLASS: PRIEST - GUILD: NOZ"))); 
		for(int i=0; i<nbActions; i++)
		{
			effects = generator.getEffets(1);
			Collection<Condition> conditions =  generator.getConditions();
			deck2.addCard(new Card(-1, CardType.ACTION,"ACTION"+i, effects,  conditions, new HashMap<String, String>()));
		}
