	...
	public Collection<Effect> getEffets(int number)
	{
		...
		for(int i=0; i< number; i++)
		{
			...
			case 5: 
				...
				break;
			case 6: 
				effects.add(new TurnActiveEffect(
						new CharacterSettingModificationEffect("DEF", 1, Target.SELF), turns));
				break;
			case 7: 
				effects.add(new TurnActiveEffect(
						new CharacterSettingModificationEffect("ATT", 1, Target.SELF), turns));
				break;
			case 8: 
				effects.add(new TurnActiveEffect(
						new CharacterSettingModificationEffect("DEF", -2, Target.OPPONENT), turns));
				break;
			case 9: 
				effects.add(new IrreversibleCharacterSettingModificationEffect("LIFE", -2, Target.OPPONENT));
				break;
			case 10: 
				effects.add(new IrreversibleCharacterSettingModificationEffect("LIFE", -2, Target.OPPONENT));
				break;
	...
	public Collection<Condition> getConditions()
	{
		...
		if(Math.random() > 0.5)
		{
			...
			case 3: 
				...
				break;
			case 4: 
				conditions.add(new CharacterSettingCondition("CLASS", Sign.EQUALS, "WARRIOR", Target.SELF));
				break;
			case 5: 
				conditions.add(new CharacterSettingCondition("CLASS", Sign.EQUALS, "PRIEST", Target.SELF));
				break;
			}
		}
