...
public class CharacterSettingConditionTest extends TestCase 
{
	...
	{
		CharacterSettingCondition condition = new CharacterSettingCondition(
				settingName, Sign.GREATER, "2", Target.SELF);
	...
	{
		CharacterSettingCondition condition = new CharacterSettingCondition(
				settingName, Sign.GREATER_EQUALS, "2", Target.SELF);
	...
	{
		CharacterSettingCondition condition = new CharacterSettingCondition(
				settingName, Sign.EQUALS, "2", Target.SELF);
	...
	{
		CharacterSettingCondition condition = new CharacterSettingCondition(
				settingName, Sign.LESS_EQUALS, "2", Target.SELF);
	...
	{
		CharacterSettingCondition condition = new CharacterSettingCondition(
				settingName, Sign.LESS, "2", Target.SELF);
